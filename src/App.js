  ...
  useEffect(() => {
    const fetchAiIntroduction = async () => {
      ...
      try {
        ...
        const response = await axios.get(`.netlify/functions/aichat?input=your name is "simpl" (s,i,m,p,l) and you are an ai assistant designed to answer the user's questions. Introduce yourself in 128 characters max and in ${languageNames.of(navigator.language)}}`);
